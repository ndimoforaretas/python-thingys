...
We can use the `smtplib` module to send emails with Python.
...
We can use the `smtplib` module to send emails with Python and HTML.
...
This app will send a birthday wish email to the birthday person.
...
Aretas,ndimaret@gmail.com,1986,09,29
```
